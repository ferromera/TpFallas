...
<div class="fieldcontain ${hasErrors(bean: knowledgeBaseInstance, field: 'padre', 'error')} required">
	...
	<g:select id="" name="padre.id" from="${tpFallas.frame.Padre.list()}" optionKey="id" required="" value="${knowledgeBaseInstance?.padre?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: knowledgeBaseInstance, field: 'madre', 'error')} required">
	...
	<g:select id="madre" name="madre.id" from="${tpFallas.frame.Madre.list()}" optionKey="id" required="" value="${knowledgeBaseInstance?.madre?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: knowledgeBaseInstance, field: 'nino', 'error')} required">
	...
	<g:select id="nino" name="nino.id" from="${tpFallas.frame.Nino.list()}" optionKey="id" required="" value="${knowledgeBaseInstance?.nino?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: knowledgeBaseInstance, field: 'vivienda', 'error')} required">
	...
	<g:select id="vivienda" name="vivienda.id" from="${tpFallas.frame.Vivienda.list()}" optionKey="id" required="" value="${knowledgeBaseInstance?.vivienda?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: knowledgeBaseInstance, field: 'violencias', 'error')} ">
	...
	<g:select name="violencias" from="${tpFallas.frame.ViolenciaFamiliar.list()}" multiple="multiple" optionKey="id" size="5" value="${knowledgeBaseInstance?.violencias*.id}" class="many-to-many"/>
...
<div class="fieldcontain ${hasErrors(bean: knowledgeBaseInstance, field: 'entrevistas', 'error')} ">
	...
	<g:select name="entrevistas" from="${tpFallas.frame.Entrevista.list()}" multiple="multiple" optionKey="id" size="5" value="${knowledgeBaseInstance?.entrevistas*.id}" class="many-to-many"/>
...
<div class="fieldcontain ${hasErrors(bean: knowledgeBaseInstance, field: 'nuevaPareja', 'error')}">
	...
	<g:select id="nuevaPareja" name="nuevaPareja.id" from="${tpFallas.frame.NuevaPareja.list()}" optionKey="id" required="" value="${knowledgeBaseInstance?.nuevaPareja?.id}" class="many-to-one"/>
